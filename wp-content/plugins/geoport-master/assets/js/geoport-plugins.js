...
+function ($) {
  ...
  CSTooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="geoport-tooltip" role="tooltip"><div class="geoport-tooltip-arrow"></div><div class="geoport-tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  CSTooltip.prototype.setContent = function () {
    ...
    $tip.find('.geoport-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
  ...
  CSTooltip.prototype.arrow = function () {
    return (this.$arrow = this.$arrow || this.tip().find('.geoport-tooltip-arrow'))
  }
