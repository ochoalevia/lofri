 ...
 *
 */
class GEOPORTFramework_Option_Sorter extends GEOPORTFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : esc_html__( 'Enabled Modules', 'geoport' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : esc_html__( 'Disabled Modules', 'geoport' );

    echo '<div class="geoport-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="geoport-enabled">';
    if( ! empty( $enabled ) ) {
    ...
    echo '<ul class="geoport-disabled">';
    if( ! empty( $disabled ) ) {
