 ...
 *
 */
defined( 'GEOPORT_VERSION' )    or  define( 'GEOPORT_VERSION',    '2.0.7' );
defined( 'GEOPORT_OPTION' )     or  define( 'GEOPORT_OPTION',     '_geoport_options' );
defined( 'GEOPORT_CUSTOMIZE' )  or  define( 'GEOPORT_CUSTOMIZE',  '_geoport_customize_options' );
 ...
 *
 */
if( ! function_exists( 'geoport_get_path_locate' ) ) {
  function geoport_get_path_locate() {
    ...
    return apply_filters( 'geoport_get_path_locate', array(
 ...
 *
 */
$get_path = geoport_get_path_locate();

defined( 'GEOPORT_BASENAME' )  or  define( 'GEOPORT_BASENAME',  $get_path['basename'] );
defined( 'GEOPORT_DIR' )       or  define( 'GEOPORT_DIR',       $get_path['dir'] );
defined( 'GEOPORT_URI' )       or  define( 'GEOPORT_URI',       $get_path['uri'] );
 ...
 *
 */
if( ! function_exists( 'geoport_locate_template' ) ) {
  function geoport_locate_template( $template_name ) {

    $located      = '';
    $override     = apply_filters( 'geoport_framework_override', 'geoport-framework-override' );
    ...
    $dir_template = GEOPORT_BASENAME .'/'. $template_name;
    ...
    $located = apply_filters( 'geoport_locate_template', $located, $template_name );
